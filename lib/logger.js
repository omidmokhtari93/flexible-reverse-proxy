...
class PrettyLogger {
  ...
  // Server startup logs
  serverStart(port, host, logLevel, routes = {}, forwardAll = null) {
    ...
    if (forwardAll) {
      console.log(`${chalk.blue("🔄")} Forward-all mode: All traffic → ${chalk.green(forwardAll)}`);
